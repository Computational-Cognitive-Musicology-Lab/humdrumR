...
test_that("Exclusive is updated by update_Exclusive", {
  ...
  expect_equal(chorales |> humdrumR:::pullPrintable('Token', 'ED') |> pull(1) |> _[1], '**kern')
  expect_equal(chorales |> humdrumR:::pullPrintable('Nchar', 'ED') |> pull(1) |> _[1], '**kern')
  expect_equal(chorales |> humdrumR:::pullPrintable('Semits', 'ED') |> pull(1) |> _[1], '**semits')
  expect_equal(chorales |> humdrumR:::pullPrintable('Pitch', 'ED') |> pull(1) |> _[1], '**pitch')
