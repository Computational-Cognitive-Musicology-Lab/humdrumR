...
If `pc()` is applied to a [humdrumR data
...
- ten:
  ...
  ***A shorthand-symbol to use for 10.***
...
- eleven:
  ...
  ***A shorthand-symbol to use for 11.***
...
results
#> **pc (character)
#>  [1] . 0 7 B 7 0 7 5 5 5 5 7 4 7 2 0 . 4 7 0 4 7 0 0 4 4 7 4 7 2 5 0 4 0 9 0 9 0
#> [39] 7 5 B 4 0 .
```
