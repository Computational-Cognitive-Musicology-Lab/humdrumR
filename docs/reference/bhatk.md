...
[Swara](https://en.wikipedia.org/wiki/Svara) are syllabes used to
represent scale degrees in hindustani music—like solfege.

If `bhatk()` is applied to a [humdrumR data
...
results
#> **bhatk (character)
#>  [1] .   S,  P   N,  P   S,  P   M,, M,  M,, M,  P,  G,  P,  R,  S,  .   G   P' 
#> [20] S   G   P   S   S   G   G   P'  G   P'  R   M   S   G   S   D'  S   D'  S  
#> [39] P'  M,  N   G,  S   .  
```
