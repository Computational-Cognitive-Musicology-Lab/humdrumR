...
[Scientific pitch](https://en.wikipedia.org/wiki/Scientific_pitch) is
the most standard approach to representing pitch in traditional Western
music.

If `pitch()` is applied to a [humdrumR data
...
the pitch functions (like `pitch()` and
...
results
#> **pitch (character)
#>  [1] .   F3  C4  E3  C4  F3  C4  Bb2 Bb3 Bb2 Bb3 C3  A3  C3  G3  F3  .   A4  C5 
#> [20] F4  A4  C4  F4  F4  A4  A4  C5  A4  C5  G4  Bb4 F4  A4  F4  D5  F4  D5  F4 
#> [39] C5  Bb3 E4  A3  F4  .  
```
