...
This is the representation used to represent pitches in the [Helmholtz
notation](https://en.wikipedia.org/wiki/Helmholtz_pitch_notation)
format.

If `helmholtz()` is applied to a [humdrumR data
...
results
#> **helmholtz (character)
#>  [1] .   f   c'  E'  c'  f   c'  Bb  bb  Bb  bb  C'  a   C'  g   f   .   a'  c''
#> [20] f'  a'  c'  f'  f'  a'  a'  c'' a'  c'' g'  bb' f'  a'  f'  d'' f'  d'' f' 
#> [39] c'' bb  e'  a   f'  .  
```
