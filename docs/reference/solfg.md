...
Based on the common French system of notating pitches, as encoded in the
humdrum [`**solfg`](https://www.humdrum.org/rep/solfg/index.html)
interpretation.

If `solfg()` is applied to a [humdrumR data
...
results
#> **solfg (character)
#> [1] so2   so3   mi3   fa~d3 so3   re3   mi3  
...
results
#> **solfg (character)
#>  [1] .     fa3   do4   mi3   do4   fa3   do4   ti~b2 ti~b3 ti~b2 ti~b3 do3  
#> [13] la3   do3   so3   fa3   .     la4   do5   fa4   la4   do4   fa4   fa4  
#> [25] la4   la4   do5   la4   do5   so4   ti~b4 fa4   la4   fa4   re5   fa4  
#> [37] re5   fa4   do5   ti~b3 mi4   la3   fa4   .    
```
