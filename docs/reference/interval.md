...
This returns the standard representations of
[intervals](https://en.wikipedia.org/wiki/Interval_(music)) in Western
music.

If `interval()` is applied to a [humdrumR data
...
results
#> **interval (character)
#>  [1] .   -P5 P1  -m6 P1  -P5 P1  -M9 -M2 -M9 -M2 -P8 -m3 -P8 -P4 -P5 .   +M6 +P8
#> [20] +P4 +M6 P1  +P4 +P4 +M6 +M6 +P8 +M6 +P8 +P5 +m7 +P4 +M6 +P4 +M9 +P4 +M9 +P4
#> [39] +P8 -M2 +M3 -m3 +P4 .  
```
