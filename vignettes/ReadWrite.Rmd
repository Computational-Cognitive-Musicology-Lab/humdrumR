...
As you can see, the REpath-pattern includes directory (folder) paths (relative or absolute)---using your operating system's appropriate delimiter ("\" for windows, "/" for everybody else)---*and* a pattern for matching file paths.
