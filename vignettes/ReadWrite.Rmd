...
Whenever we specify more than one REpath-pattern, `r hm` gives them names which we can access in the `Label` field of the resulting `r hm` data object.
...
This code is used to keep track of modifications to humdrum datasets.
