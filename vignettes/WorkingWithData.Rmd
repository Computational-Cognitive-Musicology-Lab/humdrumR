...
This pattern, with `orelse` set to `Token` is quite common.
...
Instead of our normal "do" argument, we can specify a `fill` command; `fill` will recycle its output to match
