...
One option is to "pull" the fields we want out---as explained above in the [accessing fields](DataFields.html#accessing-fields) sections above---and then work with them like any normal R data structures.
...
It is applied to the first **selected** field, which we learned about [above](DataFields.html#selecting-fields).
...
And there are other advantages, which we'll learn about in other articles!
