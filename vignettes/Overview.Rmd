...
`r Hm` code provides tools for the visualization, manipulation, and analysis of [humdrum data](http://www.humdrum.org/guide/ch05/).
...
The Humdrum "universe" includes two parts: a data format called the *humdrum syntax* and musicological software system
...
The package has seven main components:
